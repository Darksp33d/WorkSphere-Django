...
from worksphere.views.api_view import get_emails, start_outlook_auth, outlook_auth_callback, send_email, delete_email, mark_email_read
...
urlpatterns = [
    ...
    path('api/delete-email/', delete_email, name='delete_email'),
